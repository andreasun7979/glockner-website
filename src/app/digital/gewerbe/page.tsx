...
export default function DigitalGewerbePage() {
  return (
    <>
      {/* HERO ─────────────────────────────────────────── */}
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="font-mono text-[12px] md:text-[13px] tracking-[0.18em] uppercase text-slate-300 font-bold mb-3">
            Beratung &nbsp;<span className="text-aurum">·</span>&nbsp; Gewerbebetrieb
          </div>

          <h1 className="font-serif-display font-medium text-white text-3xl md:text-5xl lg:text-6xl leading-[1.08] tracking-[-0.02em] m-0">
            Wir bringen Ihnen mit nachhaltigen Digital-Strategien{" "}
            <em className="aurum-text not-italic font-medium">
              mehr Neukunden &amp; erhöhen Ihre Umsätze
            </em>
          ...
          <p className="font-serif-display italic text-slate-200 text-xl md:text-2xl leading-snug tracking-tight max-w-3xl mx-auto m-0">
            Digitale Strategie für Handwerker, Maler, Installateure &amp;
            verwandte Berufe &mdash;{" "}
            <span className="aurum-text not-italic font-semibold">
              lokal sichtbar, planbar gefunden
            </span>
            .
          </p>
      ...
      <section className="relative py-20 md:py-24 overflow-hidden border-t border-white/5">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <blockquote className="font-serif-display text-white text-3xl md:text-4xl lg:text-5xl leading-[1.15] tracking-[-0.01em] m-0">
            ...
            Wir bauen den{" "}
            <em className="aurum-text not-italic">Vertriebskanal</em>, den Ihre
            Branche wirklich braucht &mdash; Anfragen aus der{" "}
            <em className="aurum-text not-italic">Region</em>, planbar und mit
            <em className="not-italic gradient-text"> echtem Budget</em>.
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 list-none m-0 p-0">
            ...
            <li className="relative p-7 md:p-8 rounded-2xl border border-white/10 bg-brand-card hover:border-aurum/40 hover:-translate-y-1 transition-all duration-500 flex flex-col gap-5 overflow-hidden">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed mt-2 m-0">
                  Website- &amp; Sichtbarkeits-Check. Wo Ihre Region nach Ihnen sucht.
                </p>
              </div>
              ...
              <ul className="text-slate-300 text-[14px] leading-relaxed list-none m-0 p-0 space-y-1.5 flex-grow">
                {[
                  "Lokales Sichtbarkeits-Audit",
                  "Google-Maps &amp; Bewertungs-Check",
                  "Anfragen-Pfad analysieren",
            ...
            <li className="relative p-7 md:p-8 rounded-2xl border border-white/10 bg-brand-card hover:border-aurum/40 hover:-translate-y-1 transition-all duration-500 flex flex-col gap-5 overflow-hidden">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed mt-2 m-0">
                  Lokale Sichtbarkeits-Roadmap, Anfragen-Funnel,
              ...
              <ul className="text-slate-300 text-[14px] leading-relaxed list-none m-0 p-0 space-y-1.5 flex-grow">
                {[
                  "Lokale SEO &amp; Maps-Strategie",
                  "Anfragen-Funnel für Ihre Region",
            ...
            <li className="relative p-7 md:p-8 rounded-2xl border border-white/10 bg-brand-card hover:border-aurum/40 hover:-translate-y-1 transition-all duration-500 flex flex-col gap-5 overflow-hidden">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed mt-2 m-0">
                  Website neu, Maps-Setup, Bewertungs-Outreach &mdash; durch
                  unser Team oder Ihren Wunsch-Partner.
                </p>
              </div>
              <div className="flex flex-col gap-1 pt-2 border-t border-white/10">
                <span className="font-mono text-[10px] tracking-[0.16em] uppercase text-slate-500">
            ...
            {[
              {
                ...
                body: "Wenn jemand in Ihrer Region nach einem Handwerker sucht — werden Sie zuerst gefunden.",
              },
              {
                num: "02",
                title: "Anfragen aus der Region.",
                body: "Statt Glücks-Werbung: ein systematischer Anfragen-Pfad, der lokal qualifizierte Kunden zu Ihnen führt.",
              },
              {
                num: "03",
                title: "Bewertungen, die verkaufen.",
                body: "Zufriedene Kunden zu echten Bewertungen führen — automatisiert, ohne dass Sie hinterher telefonieren.",
              },
            ].map((b) => (
              <li
                key={b.num}
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <BookingWidget
              ...
              promise="Wir analysieren in 30 Minuten, wie Sie in Ihrer Region planbar gefunden werden."
            />
